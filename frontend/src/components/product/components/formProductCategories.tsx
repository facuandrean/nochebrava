...
export const FormProductCategories = ({ parsedCategories, loadingCategories, errorCategories, selectedCategoryIds, onCategoryChange, successState, successMessage, apiLoading, apiError }: FormProductCategoriesProps) => {
